...
def classify0(inX, dataSet, labels, k):
    ...
    for dis_cnt in sqDiffMat:
        sum=0.0
        sum = 10*(dis_cnt[0]*1.0034922+dis_cnt[1]*1.1391385+dis_cnt[2]*0.93573+dis_cnt[3]*3.2819568+dis_cnt[4]*0.4005737+dis_cnt[5]*0.5910047+dis_cnt[6]*1.1229324+dis_cnt[7]*1.2782804+dis_cnt[8]*0.2472484)
...
def yanzheng(prv,k):
    ...
    print("{}  is  {}".format(k,cnt/lens*1.0))

    result = pd.DataFrame(prv, columns=['y'])
    result.to_csv('knn_{}.csv'.format(k))
