...
if __name__ == '__main__':
    ...
    pipeline = Pipeline([
        ...
        ('pca', PCA()),
        ('randomforestclassifier', RandomForestClassifier(n_estimators=205,min_samples_split=8,min_samples_leaf=9,max_features='auto',max_depth=None,bootstrap=True))
    ])
