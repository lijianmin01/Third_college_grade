...
if __name__ == '__main__':
    ...
    for i in range(k):
        ...
        ID3_sum_time+=end_time-start_time
        ...
        C45_sum_time += end_time - start_time
        ...
        CART_sum_time += end_time - start_time
    ...
    CART_sum_time = CART_sum_time/k*1.0
    ...
    result = pd.DataFrame(result,index=['ID3','C45','CART'],columns=['正确率','预测时间'])
    print(result)
